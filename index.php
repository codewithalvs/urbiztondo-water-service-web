<?php include("header.php"); ?>
  <body style=" background:url(img/urb.jpg.jpg); background-size:cover;">
    ...
    <div class="container">    
        <div id="loginbox" style="margin-top:200px; margin-right:800px; width:450px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
            <div class="panel panel-info"  style=" background:url(img/urb.jpg.pjg); background-size:cover;">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <button type="submit" class="btn btn-success pull-right"><span class=""></span> Login</button>
