...
foreach ($data as $key => $value) {
    ...
    echo "<td><a rel='facebox' href='viewpayment1.php?id=" . $value['id'] . "'><span class=\"glyphicon glyphicon-eye-open\">View </a>| ";
    echo "<a rel='facebox' href='bayad.php?id=" . $value['id'] . "'>Pay Bill</td>";
    echo "</tr>";
}
